                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="relative inline-block text-left mt-3">
                        <div>
                            <x-nav-link :href="route('employees.index')"
                                ...
                                <button type="button"
                                    class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm  text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                        ...
                        <div id="menu"
                            ...
                            <div class="py-1" role="none">
                                ...
                                <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                    id="menu-item-0">{{$department->name}} {{$department->area}}</a>
                                @endforeach
                                </form>
                            </div>
                        </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                          ...
                          // Toggle the 'hidden' class on the menu when the button is clicked
